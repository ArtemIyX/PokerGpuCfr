...
def build_public_tree(
    ...
    *,
    ...
    template = PublicTreeTemplate(
        ...
        edge_parent=flat_view.edge_parent,
        edge_child=flat_view.edge_child,
        edge_action_slot=flat_view.edge_action_slot,
        edge_chance_prob=flat_view.edge_chance_prob,
        edge_infoset_id=flat_view.edge_infoset_id,
        edge_player=flat_view.edge_player,
